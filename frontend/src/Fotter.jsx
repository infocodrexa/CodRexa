      ...
      <div className="footer-container">
        ...
        <div className="footer-section about">
          ...
          <p>
            ...
            website & mobile app development and design for your business.
          </p>
          <div className="social-icons">
            <a href="https://www.facebook.com/profile.php?id=61579396951220"><FaFacebookF /></a>
            <a href="https://x.com/cod92570"><FaTwitter /></a>
            <a href="#"><FaYoutube /></a>
            <a href="#"><FaLinkedinIn /></a>
            <a href="https://www.instagram.com/codrexa?utm_source=qr&igsh=MXFsamFrazNhODZpYQ=="><FaInstagram /></a>
        ...
        <div className="footer-section contact">
          <h3>Contact Info</h3>
          <p>📍 1st floor, 13/516, Kaveri Path, Mansarovar Sector 1, Mansarovar, Jaipur, Rajasthan 302020</p>
