...
// ✅ React Icons import
import { FaGlobe, FaEnvelope, FaLock, FaServer, FaCloud, FaBolt, FaDatabase } from "react-icons/fa";
...
export default function DomainHosting() {
  ...
  return (
    <div>
      <BackgroundImage src={Hosting} alt={`hosting image loading`} marginTop="80px"/>
