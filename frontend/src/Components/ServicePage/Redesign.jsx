...
export default function Redesign() {
  ...
  const benefits = [
    { id: "health", text: "Keep your website healthy all time because ", highlight: '"health is wealth"' },
    { id: "time", text: "Update or edit your website on short notice because ", highlight: '"Time is money"' },
    { id: "security", text: "Protect your website from potential hackers because ", highlight: '"Prevention is better than cure"' },
    { id: "backup", text: "Regular backups and on-demand restoration because ", highlight: '"Data is gold"' },
    { id: "performance", text: "Constant checks to ensure peak performance because ", highlight: '"Performance matters"' },
  ];
  ...
  return (
    <div>
      ...
      {/* ✅ Breadcrumb */}
      <nav aria-label="breadcrumb" className="bg-light py-2 shadow-sm" data-aos="fade-down">
        <ol className="breadcrumb container">
          {breadcrumbData.map((item, index) => (
            <li
              key={item.id}
              className={`breadcrumb-item ${index === breadcrumbData.length - 1 ? "active fw-bold text-primary" : ""}`}
            >
      ...
      <div className="container my-5">
        ...
        <p className="text-muted" data-aos="fade-up">
          Your website needs more care than your car! Our <strong>website maintenance services</strong> are made to meet
          your requirements. Connect with us to work with the experts.
        </p>

        {/* Services Section */}
        <h2 className="fw-bold mt-5 mb-3" data-aos="zoom-in">Services</h2>
        <div className="row justify-content-center">
          {services.map((service, index) => (
            ...
            >
              <div className="card h-100 shadow border-0 hover-shadow flex-fill" style={{ minWidth: "95%" }}>
        ...
        {/* Benefits Section */}
        <h2 className="fw-bold mt-5 mb-3" data-aos="zoom-in">Benefits</h2>
        <p className="text-muted" data-aos="fade-up">
