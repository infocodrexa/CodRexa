...
import bannerImg from "../../assets/e-commerce-banner-imag.png"; // ✅ अपनी image path दें
import previewImg from "../../assets/arvino.png"; // ✅ अपनी image path दें
import servicesImg from "../../assets/about-bg-v2.png"; // ✅ अपनी image path दें
import paymentImg from "../../assets/apnikirana.png"; // ✅ अपनी image path दें
import paypalLogo from "../../assets/payment-getway-1.jpg"; // ✅ अपनी image path दें
import payuLogo from "../../assets/payment-getway-2.jpg"; // ✅ अपनी image path दें
import razorpayLogo from "../../assets/payment-getway-3.jpg"; // ✅ अपनी image path दें
import instamojoLogo from "../../assets/payment-getway-4.jpg"; // ✅ अपनी image path दें
import paykunLogo from "../../assets/payment-getway-5.jpg"; // ✅ अपनी image path दें
import ccavenueLogo from "../../assets/payment-getway-6.jpg"; // ✅ अपनी image path दें
import paytmLogo from "../../assets/payment-getway-8.jpg"; // ✅ अपनी image path दें
import direcpayLogo from "../../assets/payment-getway-9.jpg"; // ✅ अपनी image path दें
import payubizLogo from "../../assets/payment-getway-10.jpg"; // ✅ अपनी image path दें
import mobikwikLogo from "../../assets/payment-getway-11.jpg"; // ✅ अपनी image path दें
import emvantageLogo from "../../assets/payment-getway-12.jpg"; // ✅ अपनी image path दें
